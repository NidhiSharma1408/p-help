# Generated by Django 3.1.2 on 2020-11-08 11:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30, validators=[userauth.validators.validate_name])),
                ('picture', models.ImageField(blank=True, max_length=1500, null=True, upload_to='images/')),
